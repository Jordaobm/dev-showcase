  ...
  return (
    <div className="showroom-environment min-h-screen flex items-center justify-center p-6">
      ...
      >
        ...
        >
          <Compass className="w-12 h-12" style={{ color: "#DC2626" }} />
        </div>

        <h1 className="text-3xl mb-3 font-semibold">{t("shared.notFound.title")}</h1>
        ...
        <Link
          href="/"
          className="inline-block px-5 py-2.5 rounded-2xl text-sm font-medium text-gray-700 transition-all hover:scale-105"
          style={{
